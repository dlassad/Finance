        ...
        <div className="p-10">
          ...
          <form onSubmit={handleAuth} className="space-y-6">
            ...
            {!isLogin && password.length > 0 && (
              <div className="bg-gray-50 p-4 rounded-2xl space-y-2 border border-gray-100 animate-in fade-in duration-300">
            ...
            {error && <p className="text-red-500 text-[11px] font-black text-center uppercase tracking-tighter">{error}</p>}
